...
public class UsrDispatcherServlet extends DispatcherServlet {
	...
	protected String doAction(HttpServletRequest req, HttpServletResponse resp, String controllerName, String actionMethodName) {
		...
		if (controllerName.equals("home")) {
			...
			} else if (actionMethodName.equals("showMine")) {
				jspPath = memberController.showMine(req, resp);
			} else if (actionMethodName.equals("showCheckLoginPw")) {
				jspPath = memberController.showCheckLoginPw(req, resp);
			} else if (actionMethodName.equals("doCheckLoginPw")) {
				jspPath = memberController.doCheckLoginPw(req, resp);
			} else if (actionMethodName.equals("doMailAuth")) {
				jspPath = memberController.doMailAuth(req, resp);
			} else if (actionMethodName.equals("doCheckByEmail")) {
				jspPath = memberController.doCheckByEmail(req, resp);
			} else if (actionMethodName.equals("doReissuanceAuthCode")) {
				jspPath = memberController.doReissuanceAuthCode(req, resp);
			}
			...
			if (actionMethodName.equals("list")) {
				...
				jspPath = articleController.doLikeArticle(req,resp);
			} else if (actionMethodName.equals("doDislikeArticle")) {
				jspPath = articleController.doDislikeArticle(req,resp);
			} else if (actionMethodName.equals("doIncreaseArticleHit")) {
				jspPath = articleController.doIncreaseArticleHit(req,resp);
			}
			...
			if (actionMethodName.equals("doWrite")) {
				...
				jspPath = replyController.doLikeReply(req,resp);
			} else if (actionMethodName.equals("doDisLikeReply")) {
				jspPath = replyController.doDisLikeReply(req,resp);
			} else if (actionMethodName.equals("doWriteReplyReply")) {
				jspPath = replyController.doWriteReplyReply(req,resp);
			} else if (actionMethodName.equals("doWriteReplyReply")) {
				jspPath = replyController.doWriteReplyReply(req,resp);
			} else if (actionMethodName.equals("doModifyReplyReply")) {
				jspPath = replyController.doModifyReplyReply(req,resp);
			} else if (actionMethodName.equals("doDeleteReplyReply")) {
				jspPath = replyController.doDeleteReplyReply(req,resp);
